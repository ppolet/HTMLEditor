...
//// https://gitlab.resprojects.ru/mrresident/jrhw/-/tree/master/JavaRushTasks/3.JavaMultithreading/src/com/javarush/task/task32/task3209
...
при выборе этого метода. При реализации используй вызов метода из
предыдущего пункта.
